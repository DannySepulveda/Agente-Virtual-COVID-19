...
1.5 Una vez dentro daremos clic en el botón Create
...
1.8 Una vez incluido el script, el Assistant será visible en la página web como un pequeño cuadrado en la esquina inferior derecha el cual al hacer clic sobre el revelará la ventana de diálogo en la que podrás interactuar con el asistente virtual.
